...
!(function (e, t) {
    ...
    var item = e.eventRange.def.extendedProps; // Get the extended properties from the event
console.log(item)
    // Construct HTML with the provided details
    var html =
    '<div class="card border-primary mb-3">' +
        '<div class="card-body">' +
        '<h6 class="card-title mb-3">' + 
        '<span class="fw-bold">' + item.name + '</span>' + // Added fw-bold class for bold font weight
        '<small class="text-muted"> (' + item.description + ')</small>' + // Added text-muted class for muted text color
        '</h6>' +
        '<div class="attribute">' +
        '<p class="mb-1"><strong>Gujarati: </strong>' + item.gujaratiName + '</p>' +
        '</div>' +
        // '<div class="attribute">' +
        // '<p class="mb-1"><strong>Description: </strong>' + item.description + '</p>' +
        // '</div>' +
        '<div class="attribute">' +
        '<p class="mb-0"><strong>Calories: </strong>'+ item.calories + '</p>' +
        '</div>' +
        '</div>' +
        '</div>';
            ...
            return (
                (e.prototype.renderHtml = function (e) {
                    ...
                    for (var r = 0, n = e.cells; r < n.length; r++) {
                        var i = n[r];
                        t.push(
                            g(i.date, e.dateProfile, this.context, i.htmlAttrs)
                        );
                    }
                    return (
                        e.cells.length ||
            ...
            return (
                ...
                (r.prototype.showSegPopover = function (e, r, n, i) {
                    ...
                    (o = 1 === this.rowCnt ? h.el : this.rowEls[e]),
                        (l = {
                            className:
                                "fc-more-popover " + p.getClass("popover"),
                            parentEl: h.el,
            ...
            return (
                ...
                (r.prototype.render = function (t, r) {
                    ...
                    var n = this.props.dateProfile,
                        i = (this.dayTable = this.buildDayTable(
                            n,
                            t.dateProfileGenerator
                        ));
                    this.header &&
