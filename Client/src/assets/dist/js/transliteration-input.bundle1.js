!(function (t, e) {
    ...
    return (function (t) {
        ...
        function (t, e, n) {
            ...
            n(6),
                (e.enableTransliteration1 = r),
                (e.disableTransliteration1 = o),
                window &&
                    ((window.enableTransliteration1 = r),
                    (window.disableTransliteration1 = o));
        },
        function (t, e, n) {
            "use strict";
            e.__esModule = !0;
                    ...
                    return (
                        ...
                        (t.prototype.startSuggestions = function (t) {
                            ...
                            var r = n.top + 10 + i.top,
                                s = n.left + 10 + i.left;
                            r > window.innerHeight - 250 &&
                                (r = window.innerHeight - 250),
                                s > window.innerWidth - 150 &&
                                    (s = window.innerWidth - 150),
                                (this.suggestionWrapper.style.position =
                                    "fixed"),
                                (this.suggestionWrapper.style.top = r + "px"),
                                (this.suggestionWrapper.style.left = s + "px"),
                                document.getElementById("modal-edit").appendChild(this.suggestionWrapper),
                                this.suggestionWrapper.setAttribute("tabindex", "-2"),
                                this.updateDisplayState();
                        }),
            ...
            !(function () {
                ...
                function r(t, r, o) {
                    ...
                    (l.whiteSpace = "pre-wrap"),
                        ...
                        c &&
                            (u.textContent = u.textContent.replace(/\s/g, " "));
                        ...
                        return this.map(function (e) {
                            var n = (function (t, e) {
                                ...
                                if (e && "function" == typeof btoa) {
                                    var r =
                                            ((s = i),
                                            "/*# sourceMappingURL=data1:application/json;charset=utf-8;base64," +
                                                btoa(
                                                    unescape(
                                                        encodeURIComponent(
                                                            JSON.stringify(s)
                    ...
                    "function" == typeof btoa
                        ? ((n = (function (t) {
                          ...
                          (i = function (t, e, n) {
                              ...
                              r &&
                                  (i +=
                                      "\n/*# sourceMappingURL=data1:application/json;base64," +
                                      btoa(
                                          unescape(
                                              encodeURIComponent(
                                                  JSON.stringify(r)
            ...
            t.exports = function (t) {
                ...
                return t.replace(
                    ...
                    function (t, e) {
                        ...
                        return /^(#|data1:|http:\/\/|https:\/\/|file:\/\/\/|\s*$)/i.test(
                            o
                        )
                            ? t
                            : ((r =
