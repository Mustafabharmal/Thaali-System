    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (response.status === 400 && responseData.error === "Complain with this email already exists") {
                    // Show error message for duplicate email
                    alert("Another Complain with this email already exists");
                } else {
