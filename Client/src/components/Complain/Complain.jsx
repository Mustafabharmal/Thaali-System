...
function Complain() {
    ...
    return (
                ...
                <div className="container-xl">
                    <div className="row g-2 align-items-center">
                        <div className="col">
                            ...
                            <h2 className="page-title">Complain</h2>
                        </div>
                        ...
                        <div className="col-auto ms-auto d-print-none">
                            <div className="btn-list">
                                <a
                                    ...
                                    data-bs-toggle="modal"
                                    data-bs-target="#modal-Complainadd"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        className="icon"
         ...
         <div className="modal-dialog modal-sm modal-dialog-centered" role="document">
             <div className="modal-content">
                 <div className="modal-body">
                     ...
                     <div>If you proceed, the Complain will be deleted.</div>
                 </div>
     ...
     <AddComplain/>
     <EditComplain formData={formData} handleChange={handleChange} setFormData={setFormData} handleUpdate={handleUpdate} ComValues={ComValues}/>
     </>
    )
}
