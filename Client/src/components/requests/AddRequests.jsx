    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (response.status === 400 && responseData.error === "Requests with this email already exists") {
                    // Show error message for duplicate email
                    alert("Another Requests with this email already exists");
                } else {
                    console.error("Failed to create Requests");
                }
            }
        } catch (error) {
                ...
                <div className="modal-dialog modal-lg" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title">New Requests</h5>
                            <button
                                type="button"
                                className="btn-close"
